        ...
        if leftEAR < rightEAR:
            if leftEAR < EYE_AR_THRESH:
                ...
                if WINK_COUNTER > WINK_CONSECUTIVE_FRAMES:
                    ...
                    cv2.putText(frame, "LEFT CLICK", (10,120), cv2.FONT_HERSHEY_SIMPLEX, 0.7, RED_COLOR, 2)
                    WINK_COUNTER = 0
            ...
            if rightEAR < EYE_AR_THRESH:
                ...
                if WINK_COUNTER > WINK_CONSECUTIVE_FRAMES:
                    ...
                    cv2.putText(frame, "RIGHT CLICK", (10,120), cv2.FONT_HERSHEY_SIMPLEX, 0.7, RED_COLOR, 2)
                    WINK_COUNTER = 0
        else:
            WINK_COUNTER = 0
            EYE_COUNTER = 0
